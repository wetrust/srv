...
function loadConfig(){
	...
	$.get( "configuracion/me", function( data ) {
		$.each(data, function( index, element ) {
			$('#motivo-examen').append($('<option>', { value: element.me_id,text : element.me_name}));
		});
	});

	$.get( "configuracion/por", function( data ) {
		$.each(data, function( index, element ) {
			$('#motivo-examen').append($('<option>', { value: element.por_id,text : element.por_name}));
		});
	});
