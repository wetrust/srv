        ...
        $.post("https://servidor.crecimientofetal.cl/apuntes/api", formulario).done(function(data){
            if (Object.keys(data).length > 0) {
                ...
                $('#actividad\\.preset').on("click", function(){
                    ...
                    if ($(this).val() == 0){
                        $("#dialog\\.body").html('<div class="row"> <div class="col-8"> <p class="text-center">¿Desea añadir la configuración predeterminada para tipo de evento?</p></div><div class="col-4"><button type="button" class="btn btn-primary" id="dialog.cancel" data-id="0">NO</button><button type="button" class="btn btn-danger" id="dialog.delete" data-id="0">SI</button> </div></div>');
                    }
                    else{
                        $("#dialog\\.body").html('<div class="row"> <div class="col-8"> <p class="text-center">¿Está seguro de eliminar la configuración predeterminada para tipo de evento?</p></div><div class="col-4"><button type="button" class="btn btn-primary" id="dialog.cancel" data-id="0">NO</button><button type="button" class="btn btn-danger" id="dialog.delete" data-id="0">SI</button> </div></div>');
                    }
