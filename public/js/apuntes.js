$(document).ready(function(){
    ...
    $("#boton\\.calculos").on("click", function(){
        ...
        $("#boton\\.imprimir\\.resumen").on("click", function(){
            ...
            informe = informe.replace(":TABLA", table);
    ...
    $("#boton\\.configuracion").on("click", function(){
        ...
        $("input[name=actividad_predefinido]").on("click", function(){
            let valor = $('input[name=actividad_predefinido]:checked').val();
        ...
        $("#boton\\.actividad\\.guardar").on("click", function(){
            ...
            let predefinido = $('input[name=actividad_predefinido]:checked').val();
            var formulario = {
                accion: "nuevoActividad",
        ...
        $("#boton\\.otros\\.nuevo").on("click", function(){
            $("#div\\.otros").removeClass("d-none");
            $("#boton\\.otros\\.nuevo").addClass("d-none");
            $("#boton\\.otros\\.guardar").removeClass("d-none");
            $("#boton\\.otros\\.cancelar").removeClass("d-none");
        });
        
        $("#boton\\.otros\\.guardar").on("click", function(){
            $("#div\\.otros").addClass("d-none");
            $("#boton\\.otros\\.nuevo").removeClass("d-none");
            $("#boton\\.otros\\.guardar").addClass("d-none");
            $("#boton\\.otros\\.cancelar").addClass("d-none");

            var formulario = {
                accion: "nuevoOtros",
                otros_text: $("#otros\\.texto").val(),
            };
        ...
        $("#boton\\.otros\\.cancelar").on("click", function(){
            $("#div\\.otros").addClass("d-none");
            $("#boton\\.otros\\.nuevo").removeClass("d-none");
            $("#boton\\.otros\\.guardar").addClass("d-none");
            $("#boton\\.otros\\.cancelar").addClass("d-none");
...
function cargarOtros(){
    ...
    $.post("https://servidor.crecimientofetal.cl/apuntes/api", solicitud).done(function(data){
        ...
        $.each(data, function(i, item) { 
            ...
            let option = '<option value="'+ item["otros_id"]+'">' +item["otros_text"]+'</option>';
            $("#tabla\\.otros").append(fila);
            $("#formulario\\.palabras").append(option);
        });

        $(".columna-otros").on("mouseenter",function(){
            $(this).children("button").removeClass("d-none");
        }).on("mouseleave", function(){
            $(this).children("button").addClass("d-none");
        });

        $(".eliminar-otros").on("click", function(){
            let otros_id = $(this).data("id");
            $("#dialog\\.delete").remove();
            $("#dialog\\.title").html('Eliminar otros participantes')
            $("#dialog\\.body").html('<p class="text-center">¿Está seguro que desea eliminar el otro participante seccionada?</p>')
            $("#dialog\\.footer").append('<button type="button" class="btn btn-danger" id="dialog.delete" data-id="' + otros_id + '">Eliminar</button>');

            $("#dialog\\.delete").on("click", function(){
                let otros_id = $(this).data("id");
                var solicitud = {
                    accion: "eliminarOtros",
                    id: otros_id
                };
