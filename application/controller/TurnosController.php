    ...
    public function api()
    {
        ...
        switch ($accion) {
            ...
            case "turnos":
                ...
                break;
            case "turnosNuevo":
                $resultado = TurnosModel::createTurnos(Request::post('profesional'),Request::post("profesional_nombre"), Request::post('fechainic'),Request::post('horainic'),Request::post('fechafin'),Request::post('horafin'));
                break;
            case "turnosEliminar":
