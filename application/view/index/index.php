    ...
    <div class="container">
      <div class="row pt-3">
        ...
        <div class="col-7 mt-5">
          <img class="ml-lg-2 img-fluid" src="img/feto-computador.png" alt="logo" >
        </div>
      </div>
    </div>
  </div>
