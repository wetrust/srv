...
$pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[1][1], '60', 170, 100, 88, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    ...
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[1][1], '130', '', 106, 74, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    ...
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[3][1], '130', '', 106, 74, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
}
    ...
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[2][1], PDF_MARGIN_LEFT, '115', 88, 63, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[3][1], '110', '', 88, 63, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[4][1], PDF_MARGIN_LEFT, '186', 88, 63, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
