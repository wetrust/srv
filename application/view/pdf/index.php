...
$pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[0], '60', '', 100, 88, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
$pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[1], '60', 170, 100, 88, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
}
...
$pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[3], '110', '', 90, 66, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    ...
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[0], '', '', 80, 62, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[1], '110', '', 80, 62, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[2], PDF_MARGIN_LEFT, '130', 80, 62, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[3], '110', '', 80, 62, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[4], PDF_MARGIN_LEFT, '189', 80, 62, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
    $pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[5], '210', '', 80, 62, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
