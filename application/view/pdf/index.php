...
$pdf->writeHTMLCell(40, 10, '', '', $html, 0, 1, 0, true, '', true);
...
$pdf->Image(Config::get('DICOM_DIRECTORY') . $this->user_images[2], PDF_MARGIN_LEFT, '130', 86, 62, 'JPG', '', 'T', true, 150, '', false, false, 1, false, false, false);
