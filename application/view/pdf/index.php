...
<hr>
<div style="box-sizing: border-box;"><div style="max-width:33%;position: relative;display: block;box-sizing: border-box;float: left;"><strong>Paciente Sra. (Srta.):</strong> FABIOLA REYES VENEGAS</div><div style="max-width:33%;position: relative;display: block;box-sizing: border-box;float: left;"><strong>RUT:</strong> 17378168-7</div><div style="max-width:33%;position: relative;display: block;box-sizing: border-box;float: left;"><strong>Fecha de Exámen:</strong> 29 de 03 de 2018</div></div>
EOD;
