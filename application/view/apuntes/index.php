        ...
        $(document).ready(function(){
            ...
            $("#boton\\.imprimir").on("click", function(){
                ...
                if (texto.length > 0){
                    ...
                    let informe = '<html lang="es"><head> <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Material+Icons"> <link rel="stylesheet" href="https://unpkg.com/bootstrap-material-design@4.1.1/dist/css/bootstrap-material-design.min.css" integrity="sha384-wXznGJNEXNG1NFsbm0ugrLFMQPWswR3lds2VeinahP8N0zJw9VWSopbjv2x7WCvX" crossorigin="anonymous"> <title>Notas de apuntes</title></head><body> <h1 class="text-center mb-4">Informe apunte de eventos</h1> <hr> <div class="row"> <div class="col"> <p><strong>Nombre del evento</strong><br>:PACIENTE</p></div></div><div class="row"> <div class="col"> <p><strong>Fecha</strong><br>:FECHA</p></div></div><div class="row"> <div class="col"> <p><strong>Hora</strong><br>:HORA</p></div></div><div class="row"> <div class="col"> <p><strong>Otros participantes</strong><br>:PALABRAS</p></div></div><div class="row"> <div class="col"> <p><strong>Lugar del evento</strong><br>:LUGAR</p></div></div><div class="row"> <div class="col"> <p><strong>Cierre de evento</strong><br>:CANCELACION</p></div></div><div class="row"> <div class="col"> <p><strong>Tipo de evento</strong><br>:ACTIVIDAD</p></div></div><div class="row"> <div class="col"> <p><strong>Fecha de cancelación</strong><br>:FCANCELACION</p></div></div><div class="row"> <div class="col"> <p><strong>Valor cancelado</strong><br>:VALOR</p></div></div><div class="row"> <div class="col"> <p><strong>Comentarios generales</strong><br>:COMENTARIOS</p></div></div></body></html>';
