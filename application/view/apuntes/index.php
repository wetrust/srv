                    ...
                    <div class="card-body">
                        ...
                        <div class="row m-0">
                            <div class="col">
                                ...
                                <div class="form-group"><label for="formulario.lugar"><strong>Lugar del evento</strong>(<i class="fas fa-search text-success"></i>)</label><select class="form-control" id="formulario.lugar" disabled></select></div>
                                <div class="form-group"><label for="formulario.actividad"><strong>Método de búsqueda</strong>(<i class="fas fa-search text-success"></i>)</label><select class="form-control" id="formulario.actividad" disabled></select></div>
                                ...
                                <div class="d-none" id="div.financiero">
                                    <div class="form-group mt-4"><label for="formulario.cancelacion"><strong>Cancelación $</strong> (<i class="fas fa-search text-success"></i>)</label><select class="form-control" id="formulario.cancelacion" disabled></select></div>
