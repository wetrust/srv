                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-8">
                                <div class="form-group"><label for="formulario.comentarios">Comentarios generales</label><textarea class="form-control" id="formulario.comentarios" rows=18"></textarea></div>
                            </div>
                        </div>
                        <div class="row m-0">
