        ...
        <div class="row">
            ...
            <div class="col px-0 border-left">
                ...
                <div class="row mt-1 mx-0" style="overflow: hidden;height: calc(100vh - 150px); display:none;" id="postnatal">
                    ...
                    <div class="col">
                        <p>Proyecto a desarrollar; en la clasica categorización Peso/Edad gestacional, se explora el efecto modulador del peso según diversas variables biológicas, obteniendo con ello curvas customizadas.</p>
