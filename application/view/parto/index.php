        ...
        <div class="row">
            <div class="col-2 px-0 mt-4">
                <ul class="nav flex-column pt-2">
                    ...
                    <li class="nav-item ml-2">
                        <a href="#hipoglicemia" class="btn btn-primary p-1 text-left"><small>Protocolo hipoglicemia<br>neonatal</small></a>
                    </li>
                    <li class="nav-item ml-2 my-1">
                        Ver PDF de curvas
                    </li>
            ...
            <div class="col px-0 border-left">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="row mb-0">
                                        ...
                                        <div class="col-2"></div>
                                        <h6 class="col-3" id="tituloAjusteAlto" style="font-size: 0.8rem;height: 2rem;">Percentil de Peso/Ege sin ajuste</h6>
                                        <div class="col-2">
                                    ...
                                    <div class="row mb-0">
                                        ...
                                        <div class="col-2"></div>
                                        <h6 class="col-3" id="tituloAjusteBajo" style="font-size: 0.8rem;height: 2rem;">Percentil de Peso/Ege con ajuste</h6>
                                        <div class="col-2">
                ...
                <div class="row mt-1 mx-0" style="overflow: hidden;height: calc(100vh - 150px); display:none;" id="hipoglicemia">
                    <div class="col-12 h-100" style="overflow: auto;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 my-3">
                                        ...
                                        <div class="row p-2 border border-info border-top-0" ">
                        ...
                        <div class="card mt-2">
                            <div class="card-header p-1 pl-3 bg-primary">
                                <p class="m-0 text-white">- Ejemplo peso categorizado en funcion de la Ege/Parto: (1) Curva local generalizada y (2) curva general personalizada según variables.</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
