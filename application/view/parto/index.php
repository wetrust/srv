        ...
        <div class="row">
            ...
            <div class="col px-0 border-left">
                ...
                <div class="row mt-1 mx-0" style="overflow: hidden;height: calc(100vh - 150px); display:none;" id="postnatal">
                    ...
                    <div class="col">
                        <h6 class="alert-heading text-azul">Proyecto a desarrollar; en la clasica categorización Peso/Edad gestacional, se explora el efecto modulador del peso neonatal según diversas variables biológicas, obteniendo con ello curvas customizadas.</h6>
                    ...
                    <div class="col-12 h-100" style="overflow: auto;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mt-2">La Diferencia observada (Percentil), ha de ser contrastada con morbilidad neonatal prevalente en la población general de recién nacido, ejemplo hipoglicemia neonatal.</p>
                            </div>
                        </div>
                        <div class="card mt-2">
                            <div class="card-body">
