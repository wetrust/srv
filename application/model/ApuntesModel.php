...
class ApuntesModel
{
    ...
    public static function getApunte($apunte_id)
    {
        ...
        $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_id = :apunte_id LIMIT 1";
        $query = $database->prepare($sql);
    ...
    public static function getFilterApunte($uno,$dos,$lugar,$actividad,$cancelacion)
    {
        ...
        if (($lugar == 99) && ($actividad == 99) && ($cancelacion == 99)){
            $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_date BETWEEN :apunte_date AND :apunte_date2 ORDER BY apunte_date";
            $query = $database->prepare($sql);
            $query->execute(array(':user_id' => Session::get('user_id'), ':apunte_date' => $uno, ':apunte_date2' => $dos));
        }
        else{
            if (($lugar !== 99) && ($actividad !== 99) && ($cancelacion !== 99)){
                $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_location = :apunte_location AND apunte_activity = :apunte_activity AND apunte_cancellation = :apunte_cancellation AND apunte_date BETWEEN :apunte_date AND :apunte_date2 ORDER BY apunte_date";
                $query = $database->prepare($sql);
                ...
                $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_location = :apunte_location AND apunte_activity = :apunte_activity  AND apunte_date BETWEEN :apunte_date AND :apunte_date2 ORDER BY apunte_date";
                $query = $database->prepare($sql);
                ...
                $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_location = :apunte_location AND apunte_cancellation = :apunte_cancellation AND apunte_date BETWEEN :apunte_date AND :apunte_date2 ORDER BY apunte_date";
                $query = $database->prepare($sql);
                ...
                $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_activity = :apunte_activity AND apunte_cancellation = :apunte_cancellation AND apunte_date BETWEEN :apunte_date AND :apunte_date2 ORDER BY apunte_date";
                $query = $database->prepare($sql);
                ...
                $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_location = :apunte_location AND apunte_date BETWEEN :apunte_date AND :apunte_date2 ORDER BY apunte_date";
                $query = $database->prepare($sql);
                $query->execute(array(':user_id' => Session::get('user_id'), ':apunte_date' => $uno, ':apunte_date2' => $dos, ':apunte_location' => $lugar));
            }
            else if  (($lugar == 99) && ($actividad == 99) && ($cancelacion !== 99)){
                $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_cancellation = :apunte_cancellation AND apunte_date BETWEEN :apunte_date AND :apunte_date2 ORDER BY apunte_date";
                $query = $database->prepare($sql);
                $query->execute(array(':user_id' => Session::get('user_id'), ':apunte_date' => $uno, ':apunte_date2' => $dos, ':apunte_cancellation' => $cancelacion));
            }
            else if  (($lugar == 99) && ($actividad !== 99) && ($cancelacion == 99)){
                $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_minute, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_activity = :apunte_activity AND apunte_date BETWEEN :apunte_date AND :apunte_date2 ORDER BY apunte_date";
                $query = $database->prepare($sql);
     ...
     */
    public static function createApunte($apunte_date, $apunte_hour, $apunte_activity, $apunte_location, $apunte_cancellation, $apunte_fcancellation, $apunte_cost,  $apunte_text, $apunte_keywords, $location_name, $apunte_participante, $apunte_nombre, $apunte_minute)
    {

        $database = DatabaseFactory::getFactory()->getConnection();

        $sql = "INSERT INTO apuntes (apunte_date, apunte_hour, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, user_id, apunte_location_name, apunte_participante, apunte_nombre, apunte_minute) VALUES (:apunte_date, :apunte_hour, :apunte_activity, :apunte_location, :apunte_cancellation, :apunte_fcancellation, :apunte_cost, :apunte_text, :apunte_keywords, :user_id, :apunte_location_name, :apunte_participante, :apunte_nombre, :apunte_minute)";
        $query = $database->prepare($sql);
        $query->execute(array(':apunte_date' => $apunte_date, ':apunte_hour' => $apunte_hour, ':apunte_activity' => $apunte_activity, ':apunte_location' => $apunte_location, ':apunte_cancellation' => $apunte_cancellation, ':apunte_fcancellation' => $apunte_fcancellation, ':apunte_cost' => $apunte_cost, ':apunte_text' => $apunte_text, ':apunte_keywords' => $apunte_keywords, ':user_id' => Session::get('user_id'), ':apunte_location_name' => $location_name, ':apunte_participante' => $apunte_participante, ':apunte_nombre' => $apunte_nombre, ':apunte_minute' => $apunte_minute));
     ...
     */
    public static function updateApunte($apunte_id, $apunte_date, $apunte_hour, $apunte_activity, $apunte_location, $apunte_cancellation, $apunte_fcancellation, $apunte_cost, $apunte_text, $apunte_keywords, $location_name, $apunte_participante, $apunte_nombre, $apunte_minute)
    {
        if (!$apunte_id) {
            return false;
        }
    ...
    public static function getActividad($actividad_id)
    {
        ...
        $sql = "SELECT actividad_id, actividad_text, actividad_preset, actividad_apuntes FROM actividades WHERE user_id = :user_id AND actividad_id = :actividad_id LIMIT 1";
        $query = $database->prepare($sql);
