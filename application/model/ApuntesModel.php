...
class ApuntesModel
{
    ...
    public static function getAllApuntes()
    {
        ...
        $sql = "SELECT  apunte_id, apunte_date, apunte_hour, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id LIMIT 10";
        $query = $database->prepare($sql);
    ...
    public static function getApunte($apunte_id)
    {
        ...
        $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, apunte_nombre FROM apuntes WHERE user_id = :user_id AND apunte_id = :apunte_id LIMIT 1";
        $query = $database->prepare($sql);
    ...
    public static function getFilterApunte($uno,$dos,$lugar,$actividad,$cancelacion)
    {
        ...
        if (($lugar == 99) && ($actividad == 99) && ($cancelacion == 99)){
            $sql = "SELECT apunte_id, apunte_date, apunte_hour, apunte_participante, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords FROM apuntes WHERE user_id = :user_id AND apunte_date BETWEEN :apunte_date AND :apunte_date2";
            $query = $database->prepare($sql);
     ...
     */
    public static function createApunte($apunte_date, $apunte_hour, $apunte_activity, $apunte_location, $apunte_cancellation, $apunte_fcancellation, $apunte_cost,  $apunte_text, $apunte_keywords, $location_name, $apunte_participante, $apunte_nombre)
    {

        $database = DatabaseFactory::getFactory()->getConnection();

        $sql = "INSERT INTO apuntes (apunte_date, apunte_hour, apunte_activity, apunte_location, apunte_cancellation, apunte_fcancellation, apunte_cost, apunte_text, apunte_keywords, user_id, apunte_location_name, apunte_participante, apunte_nombre) VALUES (:apunte_date, :apunte_hour, :apunte_activity, :apunte_location, :apunte_cancellation, :apunte_fcancellation, :apunte_cost, :apunte_text, :apunte_keywords, :user_id, :apunte_location_name, :apunte_participante, :apunte_nombre)";
        $query = $database->prepare($sql);
     ...
     */
    public static function updateApunte($apunte_id, $apunte_date, $apunte_hour, $apunte_activity, $apunte_location, $apunte_cancellation, $apunte_fcancellation, $apunte_cost, $apunte_text, $apunte_keywords, $location_name, $apunte_participante, $apunte_nombre)
    {
        if (!$apunte_id) {
            return false;
        }
