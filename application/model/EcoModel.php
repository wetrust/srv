...
class EcoModel
{
    public static function getEcos($rut, $tipo)
    {
        ...
        if ($tipo == 1){
            ...
            $sql = "SELECT * FROM parto WHERE user_id = :user_id ORDER BY id_parto DESC";
            $query = $database->prepare($sql);
